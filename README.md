...
Subclasses of `jekyll_plugin_support` can utilize the `attribution` option.
...
Using the `attribution` option would cause tag subclasses to replace their usual output with HTML like:
